...
public class Profesor extends Persona{
    ...
    public Profesor(String cedula, String area, double salarioHora, double horasTrabajadas, String nombre, String direccion, String telefono, String fechaNacimiento) {
